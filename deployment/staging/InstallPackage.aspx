...
<HTML>
   <script runat="server" language="C#">
      ...
      {
          var files = Directory.GetFiles(Server.MapPath("."), "*.update", SearchOption.AllDirectories);
          ...
          using (new SecurityDisabler())
          {
              using (new ProxyDisabler())
              {
                  using (new SyncOperationContext())
                  {
                      ...
                      {
                          Response.Write("Installing Package: " + file + "<br>");
                          Install(file);
                      }
                  }
              }
   ...
   <body>
      <form id="MyForm" runat="server">
          <div>This page installs packages from its execution folder.</div>
