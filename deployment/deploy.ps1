...
$result = Invoke-WebRequest -Uri $url -TimeoutSec 600 -OutFile ".\InstallPackage-Response.log" -PassThru
...
$result = Invoke-WebRequest -Uri $url -TimeoutSec 600 -OutFile ".\Publish-Response.log" -PassThru
if($result.StatusCode -ne 200) {
    Write-Host "StatusCode: $($result.StatusCode)"
